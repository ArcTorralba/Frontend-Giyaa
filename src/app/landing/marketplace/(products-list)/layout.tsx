...
const marketplaceNavigation = [
  {
    name: 'Market',
    href: '/landing/marketplace/featured',
    icon: ShoppingCartIcon,
  },
  // TODO: Replace with icon  from mockup
  {
    name: 'My Products',
    href: '/landing/marketplace/my-products',
    icon: ShoppingBag,
  },
  { name: 'Favorites', href: '/landing/marketplace/favorites', icon: HeartIcon },
];

const categoryFilters = [
  {
    name: 'Artwork',
    href: '/landing/marketplace',
    param: 'artwork',
    icon: ImageIcon,
  },
  // TODO: Replace with icon  from mockup
